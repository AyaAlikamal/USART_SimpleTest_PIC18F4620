...
static void EUSART_BaudRate_Calculations(const usart_t *eusar){
    ...
    switch(eusar->baudrate_gen_cfg){
        case BAUDRATE_ASYNC_8BIT_LOW_SPEED:
            ...
            TXSTAbits.BRGH = 0;
            BAUDCONbits.BRG16 = 0;
            BaudRate_Temp = ((8000000UL /(float)eusar->baudrate)/ 64) - 1;
        ...
        case BAUDRATE_ASYNC_8BIT_HIGH_SPEED:
            ...
            TXSTAbits.BRGH = 1;
            BAUDCONbits.BRG16 = 0;
            BaudRate_Temp = ((8000000UL /(float)eusar->baudrate)/ 16) - 1;
            break;
        ...
        case BAUDRATE_ASYNC_16BIT_HIGH_SPEED:
            ...
            TXSTAbits.BRGH = 1;
            BAUDCONbits.BRG16 = 1;
             BaudRate_Temp = ((8000000UL /(float)eusar->baudrate)/ 4) - 1;
            break;
